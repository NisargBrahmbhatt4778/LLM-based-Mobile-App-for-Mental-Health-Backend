...
import os
from groq import AsyncGroq  #for llama3
...
class BaseAssistant(ABC):
    ...
    def __init__(self, user_info: Dict[str, Any], assistant_settings: Dict[str, Any], assistant_descriptions: List=[]) -> None:
        ...
        if "model" not in self.assistant_settings:
            #self.assistant_settings["model"] = "gpt-3.5-turbo"
            #self.assistant_settings["model"] = "gpt-4"
            self.assistant_settings["model"] = "llama3-70b-8192"
            #self.assistant_settings["model"] = "llama3-8b-8192"
    ...
    async def generate_summary(self, messages: List[Dict[str, str]]):         #never used I think
    ...
    #def num_tokens_from_messages(self, messages, model="gpt-3-turbo"):
