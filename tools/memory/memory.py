...
class Memory:
    def __init__(self, db: BaseClient=None, short_memory_length: int=10, 
                 model="llama3-8b-8192", embedding_type="llama", history_limit=3):
        '''
            ...
            embedding_type can be chosen from "gpt", "llama" for OpenAI embedding or "st" sentence transformer embedding,
            For now, st may be incompatible, due to different embedding size.
            In fact, the llama one has nothing in particular
...
class MemoryTool(BaseTool):
    ...
    def __init__(self, func: Callable=None, **kwargs) -> None:
        ...
        memory_model = kwargs.get("memory_model", "llama3-8b-8192")
